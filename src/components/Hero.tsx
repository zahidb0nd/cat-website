                ...
                <div className="flex flex-col-reverse md:flex-row items-center justify-between h-full gap-12 md:gap-8">
                    ...
                    <div className="w-full md:w-[45%] flex flex-col items-center md:items-start text-center md:text-left z-20">
                        ...
                        >
                            ...
                            <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold text-cat-charcoal leading-[1.1] mb-4">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                                <a
                                    ...
                                    className="bg-green-500 text-white px-6 py-3 rounded-full font-bold flex items-center justify-center gap-2 hover:bg-green-600 transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 w-full sm:w-auto"
                                >
                                ...
                                <a
                                    ...
                                    className="px-6 py-3 bg-white border-2 border-cat-charcoal text-cat-charcoal font-bold rounded-full hover:bg-cat-charcoal hover:text-white transition-all duration-300 flex items-center justify-center gap-2 w-full sm:w-auto"
                                >
